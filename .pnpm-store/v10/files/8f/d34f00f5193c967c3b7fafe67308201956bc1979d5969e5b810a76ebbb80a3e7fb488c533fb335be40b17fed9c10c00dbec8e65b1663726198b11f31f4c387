 ...
 */
export const layerSchemaErrorTransform = (service, transform) => Layer.succeed(service, (httpEffect, options) => Effect.catch(httpEffect, e => Schema.isSchemaError(e) ? transform(e, options) : Effect.fail(e)));
/**
 * @since 4.0.0
 * @category client
 */
