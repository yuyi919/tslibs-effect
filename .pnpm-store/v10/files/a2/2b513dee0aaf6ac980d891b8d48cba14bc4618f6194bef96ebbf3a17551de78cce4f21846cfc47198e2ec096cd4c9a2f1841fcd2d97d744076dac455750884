...
import * as InternalToCodec from "./to-codec.js";
/** @internal */
...
"~structural", "~sentinels", "meta", "toArbitrary", "toArbitraryConstraint", "toEquivalence", "toFormatter", "toCodec", "toCodecJson", "toCodecIso", AST.ClassTypeId]);
