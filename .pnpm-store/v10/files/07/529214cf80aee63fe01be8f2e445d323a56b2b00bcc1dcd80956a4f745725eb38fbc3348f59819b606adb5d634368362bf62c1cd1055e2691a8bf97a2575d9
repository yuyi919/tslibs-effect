...
export const gen: {
   ...
   * @category Creating Effects
   */
  <Eff extends Yieldable<any, any, any, any>, AEff>(f: () => Generator<Eff, AEff, never>): Effect<
    AEff,
...
export const unwrapReason: {
  ...
  <
    ...
    E
  >(errorTag: K): <A, R>(self: Effect<A, E, R>) => Effect<A, ExcludeTag<E, K> | ReasonOf<ExtractTag<E, K>>, R>
  /**
   * Promotes nested reason errors into the Effect error channel, replacing
   * the parent error.
   *
  ...
  <
    ...
    R,
    K extends TagsWithReason<E>
  >(self: Effect<A, E, R>, errorTag: K): Effect<A, ExcludeTag<E, K> | ReasonOf<ExtractTag<E, K>>, R>
