 ...
 * @since 4.0.0
 */
export declare const BadRequestFromSchemaError: Schema.decodeTo<Schema.toType<Schema.decodeTo<Schema.Union<readonly [Schema.declare<Schema.SchemaError, unknown>, typeof BadRequest]>, typeof BadRequest, never, never>>, Schema.Void, never, never>;
