...
declare const TransactionConnection_base: Context.ServiceClass<TransactionConnection, "effect/sql/SqlClient/TransactionConnection", readonly [conn: Connection.Connection, depth: number]>;
/**
 * @since 4.0.0
 */
export declare class TransactionConnection extends TransactionConnection_base {
}
/**
 * @since 4.0.0
 */
