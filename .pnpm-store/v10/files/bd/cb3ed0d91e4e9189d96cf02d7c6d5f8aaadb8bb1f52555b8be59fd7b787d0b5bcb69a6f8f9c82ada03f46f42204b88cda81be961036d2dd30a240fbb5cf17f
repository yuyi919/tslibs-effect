 ...
 * @since 4.0.0
 */
export const BadRequestFromSchemaError = /*#__PURE__*/BadRequest.pipe(Schema.decodeTo(Schema.Union([Schema.declare(Schema.isSchemaError), BadRequest]), Transformation.transform({
