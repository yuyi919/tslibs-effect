import { Effect, TestClock } from "../../src/effect-next";
import { describe, expect, it, layer, waitFor } from "../../src/BunTester";
import { Context, Layer, TxRef } from "../../src/effect-next";
...
describe("常见测试 API", () => {
  ...
  it.effect("不稳定的测试", () =>
    it.flakyTest(
      Effect.gen(function* () {
        // 模拟偶尔失败的逻辑
        const result = yield* Effect.succeed("ok");
